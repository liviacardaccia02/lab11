...
namespace ComplexAlgebra
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var onePlusI = one.Sum(i);
            var iPlusOne = i.Sum(one);
            var oneMinusI = one.Sum(i).Complement();
            var minusI = oneMinusI.Sub(one);
            
            Console.WriteLine(zero.Real); // 0
            Console.WriteLine(zero.Imm); // 0
            ...
            Console.WriteLine(onePlusI.Imm); // 1
            ...
            Console.WriteLine(iPlusOne.Imm); // 1
            ...
            Console.WriteLine(oneMinusI.Imm);  // -1
            ...
            Console.WriteLine(minusI.Imm);  // -1
